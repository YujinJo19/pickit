...
public interface ProductSellerService {
    // 상품 등록
    ProductResponse create(ProductCreateRequest request, Long sellerId, List<String> imageUrls);

    // 상품 정보 수정
    ProductResponse update(Long productId, ProductUpdateRequest request, Long sellerId,  List<String> imageUrls);
